...
import { APP_CHAIN_ID, BUNDLER_URL, ENTRYPOINT_ADDRESS, SAFE_4337_MODULE_ADDRESS, SAFE_WEBAUTHN_SHARED_SIGNER_ADDRESS } from './constants'
...
function getEip4337BundlerProvider(): ethers.JsonRpcProvider {
  const provider = new ethers.JsonRpcProvider(BUNDLER_URL, undefined, {
    batchMaxCount: 1,
  })
  return provider
}
